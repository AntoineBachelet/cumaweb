...
urlpatterns = [
    ...
    path("borrow/<int:pk>/update/", views.BorrowUpdateView.as_view(), name="borrow_update"),
    path("borrow/<int:pk>/delete/", views.BorrowDeleteView.as_view(), name="borrow_delete"),
